...
#ifdef __cplusplus
//extern "C" _declspec(dllexport) int __cdecl CreateSecureDrive(wchar_t* pszParam1, wchar_t* pszParam2, wchar_t* pszParam3);
//extern "C" _declspec(dllexport) int __cdecl CreateSecureDrive(wchar_t* pszParam1, wchar_t* pszParam2, char* pszParam3, int nParam3Length);
